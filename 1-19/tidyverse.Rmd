...
knitr::opts_chunk$set(cache = TRUE, error = TRUE, fig.width = 7, fig.height = 5, fig.asp = 1)
```
...
![A visual schematic to help you think about ggplot2 correctly -- credit: [Myfanwy Johnston](https://github.com/Myfanwy/ggplot2Intro)](https://raw.githubusercontent.com/Myfanwy/ggplot2Intro/master/figures/ggplot_structure.png)

Some good tutorials include:

- [Variance Explained](http://varianceexplained.org/RData/lessons/lesson2/)
...
```{r switch figure size, include = FALSE}
...
```
 ...
 [\\]: # \textcolor{red}{add + scale\_y\_log10()}
